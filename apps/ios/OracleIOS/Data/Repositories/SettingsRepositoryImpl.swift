...
final class SettingsRepositoryImpl: SettingsRepository {
    ...
    // Keys
    private enum Keys {
        static let calendarType = "calendar_type"
        static let themeMode = "theme_mode"
        static let appLanguage = "app_language"
        static let faceConsent = "face.consent"
        static let lunarLeapMonthEnabled = "lunar_leap_month_enabled"
    }
    ...
    // MARK: - Lunar Leap Month
    
    var isLunarLeapMonthEnabled: Bool {
        get async throws {
            userDefaults.bool(forKey: Keys.lunarLeapMonthEnabled)
        }
    }
    
    func setLunarLeapMonthEnabled(_ enabled: Bool) async throws {
        userDefaults.set(enabled, forKey: Keys.lunarLeapMonthEnabled)
    }
}
