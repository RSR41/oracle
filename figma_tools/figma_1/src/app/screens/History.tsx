...
export const History: React.FC<HistoryProps> = ({ onNavigate }) => {
  ...
  const historyItems = [
    ...
    },
    {
      ...
      title: '3장 타로 리딩',
      date: '2026.01.27',
      description: 'The Lovers, The Star, The Sun',
      icon: Shuffle,
      color: 'bg-[#B8D4E8]',
    },
    {
